const { mockProprierties, mockLogReturn, mockCalledLogWithoutInfos, mockReturnPropriertiesValues } = require('../../../helpers/logger/fake-values');

describe('faker-values to logger helper tests', () => {
  it('mockProprierties should return the correct value', () => {
    expect(mockProprierties()).toEqual({
      severity: 'info',
  ...
  it('mockLogReturn should return the correct value', () => {
    expect(mockLogReturn()).toEqual({
      application: 'pegakienvios-core',
      level: 'info',
      message: 'Foi criada uma nova ordem de envio pelo usuário 1234 com o produto 4321, onde foi escolhida a transportadora X.',
      metadata: {
  ...
  it('mockCalledLogWithoutInfos should return the correct value', () => {
    expect(mockCalledLogWithoutInfos()).toEqual({
      severity: 'info',
      application: 'pegakienvios-core',
  ...
  it('mockReturnPropriertiesValues should return the correct value', () => {
    expect(mockReturnPropriertiesValues()).toEqual({
      severity: 'info',
      application: 'pegakienvios-core',
      application_secondary: undefined,
      class: 'ShipmentOrdeService',
